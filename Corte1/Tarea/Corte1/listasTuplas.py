...
size = len(my_lista)
print("size = ", size)
#print(my_lista.pop(size))  # Puede generar error (índice fuera de rango)
...
print(my_listaSort)  # sort() devuelve None
...
my_tupla_unitaria = ('Blanco')  # Esto no es tupla realmente
